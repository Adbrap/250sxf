...
#
                ...
                i = 0
                valeuradd_mirande = 9
                for i in range(local_min[fa] - 1, local_min[ff] + valeuradd_mirande):
                    bleu.append(i)
                ...
                # --- deuxieme droite ---#
                CJ = [local_min[ff]+2, df['c'].iloc[local_max[fe]]-11]
                DJ = [local_min[ff]+2, df['c'].iloc[local_max[fe]]+1]
                ...
                if (C - B) < (C - D) and (C - B) < (E - D) and (E- F) < (E - D) and (E - F) < (C - D) and B > D and F > D  and B < C and F < E and A >= mirande2['c'].iloc[0] and verif == 0 :
                    ...
                    if accept == True:
                        ...
                        moyenne_epaule2 = ((E - F) + (J[1] - F)) / 2
                        moyenne_tete = ((C - D) + (E - D)) / 2
                        if I[1] > B and J[1] > F and moyenne_epaule1 <= moyenne_tete/2 and moyenne_epaule2 <= moyenne_tete/2 and moyenne_epaule1 >= moyenne_tete/4 and moyenne_epaule2 >= moyenne_tete/4 and df['c'].iloc[local_min[ff]+1] < J[1] and df['h'].iloc[local_min[ff]+2] >= J[1] and accept == True:
                            ...
                            plt.scatter(local_min[ff]+1, df['c'].values[local_min[ff]+1], color='orange',label='point apres F')
                            plt.scatter(local_min[ff] + 2, df['c'].values[local_min[ff] + 2], color='black',label='point apres F')
                            plt.scatter(local_min[ff] + 2, df['h'].iloc[local_min[ff] + 2], color='purple',label='le highs')
...
#
                            ...
                            while g !=1:
                                ...
                                if (df['h'].iloc[round(J[0]) + compteur2] >= J[1] + (moyenne_tete)/2) and fait_50 == 0: # !!! MODIFIER NOM OBJECTIF EN HAUT !!!!
                                    ...
                                    file.close()
                                    file = open('gain_cumulé.txt', 'w')
                                    gain_cumulé = gain_cumulé + round(((((J[1] + (moyenne_tete)/2) - (J[1]))*100)/J[1]),2)
                                    file.write(f'{round(gain_cumulé,2)}')
                                    file.close()
                                    file.close()
                                    ...
                                    file.close()
                                    file = open('df.txt', 'w')
                                    valeur2 = (J[1] + (moyenne_tete)/2)-(J[1])
